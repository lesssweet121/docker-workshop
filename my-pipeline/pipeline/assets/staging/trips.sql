...
# Define output columns, mark primary keys, and add some checks.
columns:
  - name: pickup_datetime
    type: timestamp
    description: Event pickup timestamp
    primary_key: true
    checks:
      - name: not_null
  - name: dropoff_datetime
    type: timestamp
    description: Event dropoff timestamp
  ...
  - name: payment_type_name
    type: string
    description: Payment type (human readable)
  - name: taxi_type
    type: string
...
custom_checks:
  - name: row_count_greater_than_zero
    description: Ensure staging.trips contains rows for the requested interval
    query: |
